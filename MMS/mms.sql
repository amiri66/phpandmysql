...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2025 at 04:44 PM
...
CREATE TABLE `movies` (
  `id` int(255) NOT NULL,
  `movie_emri` varchar(255) NOT NULL,
...
INSERT INTO `movies` (`id`, `movie_emri`, `movie_desc`, `movie_quality`, `movie_rating`, `movie_image`) VALUES
